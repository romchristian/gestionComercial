...
import py.gestion.compra.web.OrdenCompraBean;
...
public class OrdenCompraConverter implements Converter {
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
        ...
        OrdenCompraBean controller = (OrdenCompraBean) facesContext.getApplication().getELResolver().
                getValue(facesContext.getELContext(), null, "ordenCompraBean");
