...
import py.gestion.adm.web.ObraBean;
...
public class ObraConverter implements Converter {
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
        ...
        ObraBean controller = (ObraBean) facesContext.getApplication().getELResolver().
                getValue(facesContext.getELContext(), null, "obraBean");
