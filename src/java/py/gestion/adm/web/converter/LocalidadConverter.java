...
import py.gestion.adm.web.LocalidadBean;
...
public class LocalidadConverter implements Converter {
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
        ...
        LocalidadBean controller = (LocalidadBean) facesContext.getApplication().getELResolver().
                getValue(facesContext.getELContext(), null, "localidadBean");
